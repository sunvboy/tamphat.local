...
<div class="content">
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class=" col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2 justify-between">
            ...
            @can('rooms_create')
            <a href="{{route('rooms.create')}}" class="btn btn-primary shadow-md mr-2">Thêm mới</a>
            @endcan
        </div>
        <!-- BEGIN: Data List -->
                ...
                <tbody id="table_data" role="alert" aria-live="polite" aria-relevant="all">
                    ...
                    <tr class="odd " id="post-<?php echo $v->id; ?>">
                        ...
                        <td class="whitespace-nowrap">
                            ...
                            <a class="text-danger" href="{{route('rooms.index',['catalogueid' => $c->id])}}"><?php echo !empty($kc == 0) ? '' : ',' ?>{{$c->title}}</a><br>
                            @endforeach
                        </td>
                        ...
                        <td class="table-report__action w-56 ">
                            <div class="flex justify-center items-center">
                                @can('rooms_edit')
                                <a class="flex items-center mr-3" href="{{ route('rooms.edit',['id'=>$v->id]) }}">
