...
<script type="text/javascript">
    ...
    function get_vesion(attributesVersion = []) {
        ...
        attrs.forEach(function(data, index) {
            ...
            /*Chi nhánh */
            item = item + '<div class="mt-3 hidden">';
            ...
            item = item + '<thead>';
            item = item + '<tr>';
            item = item + '<th class="text-left py-2 font-bold text-base text-danger" style="padding-left: 5px;padding-right: 5px;">Chi nhánh</th>';
            item = item + '<th class="text-right py-2 font-bold text-base text-danger" style="padding-left: 5px;padding-right: 5px;">Tồn kho</th>';
            item = item + '</tr>';
            item = item + '</thead>';
            item = item + '<tbody>';
            <?php if (!$address->isEmpty()) { ?>
                <?php foreach ($address as $item) { ?>
                    ...
                    item = item + '<span class="font-medium"><?php echo $item->title ?> </span>(<?php echo $item->ward_name->name ?>-<?php echo $item->district_name->name ?>-<?php echo $item->city_name->name ?>)';
                    item = item + '</td>';
