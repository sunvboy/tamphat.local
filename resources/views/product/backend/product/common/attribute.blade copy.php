                                            ...
                                            <div class="mt-3 hidden">
                                                <div class="scrollbar <?php if (!in_array('addresses', $dropdown)) { ?>hidden<?php } ?>" style="max-height: 700px;">
                                                    <table class="w-full">
                                                        <thead>
                                                            <tr>
                                                                <th class="text-left py-2 font-bold text-base text-danger" style="padding-left: 5px;padding-right: 5px;">Chi nhánh</th>
                                                                <th class="text-right py-2 font-bold text-base text-danger" style="padding-left: 5px;padding-right: 5px;">Tồn kho</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <?php if (!$address->isEmpty()) { ?>
                                                                <?php foreach ($address as $item) { ?>
                                                                    <tr>
                                                                        <td class="text-left py-2"><span class="font-medium">
                                                                                <?php echo $item->title ?> </span>(<?php echo $item->ward_name->name ?>-<?php echo $item->district_name->name ?>-<?php echo $item->city_name->name ?>)
