            ...
            <div class="modal-body relative pt-[15px] border-t border-[#e5e5e5]">
                <form id="form-comment">
                    ...
                    <div class="write-review__info flex-1 flex items-end justify-between mt-3">
                        <input value="" type="text" name="fullname" placeholder="{{trans('index.Fullname')}}" class="w-[49%] h-9 leading-9 cursor-pointer rounded flex justify-center items-center outline-none focus:outline-none hover:outline-none border border-[#eeeeee] px-4 py-[6px] text-sm" required>
                        <input value="" type="text" name="phone" placeholder="{{trans('index.Phone')}}" class="w-[49%] h-9 leading-9 cursor-pointer rounded flex justify-center items-center outline-none focus:outline-none hover:outline-none border border-[#eeeeee] px-4 py-[6px] text-sm">
                    </div>
                    ...
                    <div class="flex-1 flex items-end justify-between m-0 ">
                        ...
                        <button type="submit" class="write-review__button write-review__button--submit w-1/2 bg-red-600 ml-4 h-9 leading-9 cursor-pointer rounded flex items-center justify-center text-white border-red-600 border"><span>{{trans('index.guidanhgia')}}</span>
                        </button>
                    </div>
                </form>
            </div>
