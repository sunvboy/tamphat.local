        ...
        <div class="col-span-12 lg:col-span-4">
            <div class=" box p-5 pt-3">
                <div>
                    ...
                    <?php echo Form::select('catalogue_id', $catalogues, $detail->catalogue_id, ['class' => 'tom-select tom-select-custom w-full', 'data-placeholder' => "Tìm kiếm danh mục...", 'required']); ?>
                </div>
                <div class="mt-3">
