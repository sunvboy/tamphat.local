...
<div class="box p-5 mt-3 space-y-5 <?php if (!in_array('attributes', $dropdown)) { ?>hidden<?php } ?>">
    <div class="flex items-center">
        ...
        <select class="form-control flex-1 ml-4 s_handleSelectTypeProduct" name="type">
            <option value="simple" <?php if($type=='simple' ): ?> selected="selected" <?php endif; ?>>Sản phẩm đơn giản</option>
            <option value="variable" <?php if($type=='variable' ): ?> selected="selected" <?php endif; ?>>Sản phẩm biến thể</option>
        </select>
    </div>
</div>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/childsplay/domains/childsplayclothing.vn/public_html/resources/views/product/backend/product/common/stock.blade.php ENDPATH**/ ?>