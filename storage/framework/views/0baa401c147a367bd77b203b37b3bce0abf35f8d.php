                ...
                <div class="Express-checkout mt-[40px]">
                        ...
                        <div class="">
                            ...
                            <div class="mt-5">
                                <div class="grid md:grid-cols-2 md:gap-4 space-y-4 md:space-y-0">
                                    <div class="">
                                        <input name="fullname" placeholder="<?php echo e(trans('index.Fullname')); ?> *" class="w-full h-[45px] px-4  bg-white text-f15 border">
                                    </div>
                                    <div class="">
                                        <input name="email" placeholder="Email *" class="w-full h-[45px] px-4  bg-white text-f15 border">
                                    </div>
                                    <div class="md:col-span-2">
                                        <textarea name="message" id="" cols="30" rows="10" class="w-full h-[100px]  bg-white text-f15 border p-4" placeholder="<?php echo e(trans('index.Message')); ?> *"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="mt-[10px]">
                                <button id="form-comment-submit" class="font-bold text-white h-[45px] px-[20px] bg-red-600 border border-red hover:text-white hover:bg-red-800 transition-all"><?php echo e(trans('index.Send')); ?></button>
                            </div>
                    ...
                    <div class="tour-review" style="padding-top:0px">
                        <div class="comment clearfix" style="padding-top:30px" id="getListCommentArticle">
                            <?php echo $__env->make('article.frontend.article.comment._data', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                </div>
    ...
    function get_list_object(page = 1, sort = 'id', animate = true) {
        setTimeout(function() {
            $.post('<?php echo route('commentFrontend.listCmt') ?>', {
                    page: page,
                    module: 'articles',
                    module_id: '<?php echo e($detail->id); ?>',
                    sort: sort,
...
<?php $__env->stopPush(); ?><?php /**PATH D:\xampp\htdocs\chuan.local\resources\views/article/frontend/article/comment/_comment.blade.php ENDPATH**/ ?>