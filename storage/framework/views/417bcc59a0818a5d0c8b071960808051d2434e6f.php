                    ...
                    <div class="tab-content mt-5">
                        ...
                        <div id="example-tab-<?php echo $i ?>" class="tab-pane leading-relaxed <?php if (request()->get('type') == $key) { ?>active<?php } else if (empty(request()->get('type')) &&  $i == 1) { ?>active<?php } ?>" role="tabpanel" aria-labelledby="example-<?php echo $i ?>-tab">
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                <?php $__currentLoopData = $item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="box item w-full mb-5 p-2">
                                    <a href="<?php echo e(asset($v->image)); ?>" data-fancybox><img class="w-full" style="height:300px;object-fit: contain;" src="<?php echo e(asset($v->image)); ?>" alt="<?php echo e($v->title); ?>"></a>
                                    <div class="mt-5">
                                        <div class="">
                                            <div>
                                                <h2 class="font-bold text-base mb-2"><?php echo e($v->title); ?></h2>
                                            </div>
                                            <div class="flex justify-between items-center">
                                                <div class="space-y-2">
                                                    <div class="form-check form-switch space-x-2">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('websites_edit')): ?>
                                                <a class="flex items-center mr-3 text-lg font-bold" href="<?php echo e(route('websites.edit',['id'=>$v->id])); ?>">
                                                    <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit
                                                </a>
                                                <?php endif; ?>
                                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\chuan.local\resources\views/website/index.blade.php ENDPATH**/ ?>