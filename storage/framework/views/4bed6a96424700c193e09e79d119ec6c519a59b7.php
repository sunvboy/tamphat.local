...
<title>Cập nhập Mua Kèm Deal Sốc</title>
...
<div class="content">
    <div class=" flex items-center mt-8">
        <h1 class="text-lg font-medium mr-auto">
            Cập nhập Mua Kèm Deal Sốc
        </h1>
    </div>
    <form class="grid grid-cols-12 gap-6 mt-5" id="submitFormDeals" role="form" action="<?php echo e(route('product_deals.update',['id' => $detail->id])); ?>" method="post" enctype="multipart/form-data">
        <div class=" col-span-12 lg:col-span-12">
            ...
            <div class="box p-5 mt-3">
                ...
                <div class="mt-5 space-y-3">
                    ...
                    <div id="listsProductOne">
                        <?php echo $__env->make('product.backend.deals.common.product_one', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
            <!-- END: Box sản phẩm chính -->
            <!-- START: Box Sản Phẩm mua kèm -->
            <div class="box p-5 mt-3 box-product-two">
                ...
                <div class="mt-5 space-y-3">
                    ...
                    <div id="listsProductTwo">
                        <?php echo $__env->make('product.backend.deals.common.product_two', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
            ...
            <div class="mt-3">
                <div class="text-right mt-5">
                    <button type="submit" id="btnSubmitDeal" class="btn btn-primary">Cập nhập</button>
                </div>
            </div>
            <!-- END: Form Layout -->
        </div>
            ...
            <div class="modal-body">
                ...
                <div class="mt-5 scrollbar">
                    <div class="overflow-x-auto" id="data_product">
                        <?php echo $__env->make('product.backend.deals.common.product', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
            <!-- END: Modal Body -->
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\evox.local\resources\views/product/backend/deals/edit.blade.php ENDPATH**/ ?>