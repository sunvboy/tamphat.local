...
<div class="content">
    <div class="flex justify-between items-center mt-10">
        ...
        <div class="flex flex-col md:flex-row gap-2 justify-end md:items-center">
            ...
            <a href="<?php echo e(route('receipt_groups.index')); ?>" class="flex items-center space-x-1 btn btn-primary">
                <span>Danh sách loại phiếu thu</span>
            </a>
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('receipt_vouchers_create')): ?>
            <a href="<?php echo e(route('receipt_vouchers.create')); ?>" class="btn btn-primary shadow-md mr-2">Thêm mới</a>
            <?php endif; ?>
        </div>
    </div>
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div id="loadData" class=" col-span-12">
            <?php echo $__env->make('cashbook.receipt.receipt.data', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
</div>
                ...
                swal({
                    ...
                    function(isConfirm) {
                        if (isConfirm) {
                            $.ajax({
                                type: 'POST',
                                url: "<?php echo e(route('receipt_vouchers.ajaxDelete')); ?>",
                                headers: {
                                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                                },
                                data: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\evox.local\resources\views/cashbook/receipt/receipt/index.blade.php ENDPATH**/ ?>