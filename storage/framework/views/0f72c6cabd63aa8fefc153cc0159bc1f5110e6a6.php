...
<div class="grid grid-cols-12 border-t py-5">
    <div class="col-span-12 md:col-span-3">
        <div class="flex">
            ...
            <div>
                ...
                <div class="text-xs">
                    <span><?php echo e(trans('index.dateCMT')); ?>
    ...
    <div class="col-span-12 md:col-span-9 mt-5 md:mt-0 ml-5">
        ...
        <div class="flex flex-wrap ">
            ...
            <div class="review-comment__image mb-2 mr-2 border border-slate-50 w-20 h-20 rounded bg-cover bg-center cursor-pointer" style="background-image: url(<?php echo e($image); ?>);">
            </div>
                ...
                <div class="review-sub-comment mt-2 flex">
                    ...
                    <div class="review-sub-comment-inner py-[10px] px-3 border border-[#f2f2f2] bg-[#fafafa] rounded-xl grow">
                        ...
                        <div class="flex flex-wrap mt-2">
                            ...
                            <div class="review-comment__image mb-2 mr-2 border border-slate-50 w-20 h-20 rounded bg-cover bg-center cursor-pointer" style="background-image: url(<?php echo e($imageC); ?>);">
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        <?php endif; ?>
...
</div><?php /**PATH D:\xampp\htdocs\chuan.local\resources\views/product/frontend/product/comment/data.blade.php ENDPATH**/ ?>