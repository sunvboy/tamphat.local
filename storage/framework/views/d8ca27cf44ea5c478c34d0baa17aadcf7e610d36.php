                ...
                <div class=" px-6 py-4 bg-white float-left w-full flex flex-col space-y-2">
                    ...
                    <div>
                        <div class="py-3 float-left w-auto border-b-2 border-red-600 font-bold text-base">
                            <span class=" text-red-600">Tất cả <?php echo e($page->title); ?></span>
...
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\evox.local\resources\views/product/frontend/category/products.blade.php ENDPATH**/ ?>