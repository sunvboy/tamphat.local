                        ...
                        <div class="bg-slate-100 p-2 md:p-10">
                            <div class="your-order-product-info">
                                ...
                                <ul class="border-t border-b py-5 my-5 space-y-3">
                                    ...
                                    ?>
                                    <li class="flex flex-wrap items-start justify-between cart_item border-b" data-rowid="<?php echo e($k); ?>">
                                        ...
                                        <div class="w-1/3  text-right"><span class=" text-right text-orange font-semibold total-product-item"><?php echo e(number_format($v['quantity'] * $v['price'],0,',','.')); ?>₫</span></div>
                                    </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                </ul>
