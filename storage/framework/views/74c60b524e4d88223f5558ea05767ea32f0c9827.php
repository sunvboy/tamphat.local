...
<main class="py-10 md:py-16">
    <div class="container px-4 md:px-0">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div class="space-y-8">
                <h1 class="font-bold text-[22px] tracking-[0.7px] uppercase"><?php echo e($page->title); ?></h1>
                <?php $price_coupon = 0; ?>
                ...
                ?>
                <div class="cart_item cart-<?php echo e($k); ?> flex gap-8">
                    <div class="w-[115px]">
                        <a href="<?php echo e($slug); ?>">
                            <img alt="<?php echo e($item['title']); ?>" src="<?php echo e(asset($item['image'])); ?>">
                        </a>
                    </div>
                    <div class="flex-1 ">
                        <div class="flex flex-col justify-between h-full">
                            <div class="flex justify-between">
                                <div>
                                    <p class="tracking-wider text-base"><?php echo e($item['title']); ?></p>
                                    <p class=""><?php echo e($title_version); ?></p>
                                    <p class="text-red-600"><?php echo e(number_format($item['price'])); ?>đ</p>
                                </div>
                                <?php /*
                            ...
                            <div class="flex justify-between">
                                ...
                                <div>
                                    <div class="flex items-center">
                                        <button data-rowid="<?php echo e($k); ?>" class="tp_cart_minus flex justify-center items-center w-6 h-6 bg-gray-200 rounded-full">
                                        ...
                                        <input type="number" min="1" data-rowid="<?php echo e($k); ?>" max="<?php echo e($stock); ?>" step="1" value="<?php echo e($item['quantity']); ?>" class="flex-auto w-8 text-center focus:outline-none input-appearance-none tp_cardQuantity">
                                        <button data-rowid="<?php echo e($k); ?>" class="tp_cart_plus flex justify-center items-center w-6 h-6 bg-gray-200 rounded-full">
                ...
                <div class="bg-[#f7f7f7] p-8">
                    ...
                    <?php if (in_array('coupons', $dropdown)) { ?>
                        <div class="mt-3">
                            ...
                            <div class="relative">
                                <input id="coupon_code" class="border border-solid border-gray-300 w-full px-5 mb-5 placeholder-current text-dark h-[46px] focus:outline-none text-base" placeholder="<?php echo e(trans('index.EnterDiscountCode')); ?>" type="text">
                                <button type="button" id="apply_coupon" class="absolute top-0 right-0 h-[46px] inline-block bg-global leading-none py-4 px-2 text-sm text-white transition-all hover:bg-orange uppercase font-semibold hover:text-white tracking-[0.7px] "><?php echo e(trans('index.Apply')); ?></button>
                            </div>
                        </div>
                    <?php } ?>
                    <!-- END: mã giảm giá -->
                    <div class="flex justify-between pb-5">
                        <h3 class="text-xl font-medium"><?php echo e(trans('index.TotalPrice')); ?></h3>
                    ...
                    <div class="pt-5 border-t">
                        <a href="<?php echo e(route('cart.checkout')); ?>" class="bg-global w-full text-center inline-block bg-dark leading-none py-4 px-5 md:px-8 text-sm text-white transition-all hover:bg-orange uppercase font-semibold hover:text-white tracking-[0.7px] "><?php echo e(trans('index.Pay')); ?></a>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/childsplay/domains/childsplayclothing.vn/public_html/resources/views/cart/index.blade.php ENDPATH**/ ?>