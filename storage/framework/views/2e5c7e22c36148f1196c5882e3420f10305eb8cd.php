        ...
        <div class="container mx-auto">
            <div class="grid grid-cols-12 gap-5">
                <div class="col-span-12 lg:col-span-7">
                    <div>
                        <h3 class="text-lg font-semibold mb-5 tracking-[0.7px] uppercase"><?php echo e(trans('index.BillingInformation')); ?></h3>
                ...
                <div class="col-span-12 lg:col-span-5 mt-4 mt-lg-0">
                    <div>
                        <h3 class="text-lg font-semibold mb-5 tracking-[0.7px] uppercase"><?php echo e(trans('index.InformationLine')); ?></h3>
                        <div class="bg-slate-100 p-2 md:p-10">
                            <div class="your-order-product-info">
                                ...
                                <ul class="border-t border-b py-5 my-5 space-y-3">
                                    ...
                                    ?>
                                    <li class="flex flex-wrap items-start justify-between cart_item" data-rowid="<?php echo e($k); ?>">
                                        <div class="w-2/3 action-cart-item">
                                            <div class="title">
                                                <span class=""><?php echo e($v['title']); ?> <span class="font-medium"><?php echo $title_version ?></span> X <b class="text-orange"><?php echo e($v['quantity']); ?> <?php echo e($unit); ?></b></span>
                                            </div>
                                            <div class="flex count p-2 h-11" style="padding:0;margin: 5px 0 0 0;">
                                                <div class="flex items-center">
                                                    <button data-rowid="<?php echo e($k); ?>" class="decrement flex-auto w-5 h-10 bg-white leading-none tp_cart_minus" aria-label="button">-</button>
                                                    <input type="number" min="1" max="<?php echo e(checkInventoryCheckout($v)); ?>" step="1" value="<?php echo e($v['quantity']); ?>" class="tp_cardQuantity flex-auto w-20 h-10 text-center focus:outline-none input-appearance-none card-quantity">
                                                    <button data-rowid="<?php echo e($k); ?>" class="increment flex-auto w-5 h-10 bg-white leading-none tp_cart_plus" aria-label="button" h-10>+</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="w-1/3  text-right"><span class=" text-right text-orange font-semibold total-product-item"><?php echo e(number_format($v['quantity'] * $v['price'])); ?>₫</span></div>
                                    </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                </ul>
                                ...
                                <?php if (in_array('coupons', $dropdown)) { ?>
                                        ...
                                        <ul class="flex flex-wrap items-center justify-between">
                                            ...
                                            <li class="w-1/2 text-base font-semibold text-orange text-right">
                                                <span class="cart-coupon-price">
                                                    - <?php echo e(number_format($v['price'])); ?>₫ <a href="javascript:void(0)" data-id="<?php echo e($v['id']); ?>" class="remove-coupon text-red-600 font-bold">[<?php echo e(trans('index.Delete')); ?>]</a>
                                                </span>
                                            </li>
                                        </ul>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <!-- START: mã giảm giá -->
                                    <div class="mt-5">
                                        <h3 class="text-md font-semibold mb-2"><?php echo e(trans('index.EnterDiscountCode')); ?></h3>
                                        ...
                                        <div class="relative">
                                            <input id="coupon_code" class="border border-solid border-gray-300 w-full px-2 mb-5 placeholder-current text-dark h-12 focus:outline-none text-base" placeholder="<?php echo e(trans('index.EnterDiscountCode')); ?>" type="text">
                                ...
                                <ul class="flex flex-wrap items-center justify-between border-t border-b  py-5 my-5">
                                    ...
                                    <li class="text-base font-semibold text-orange cart-total-final">
                                        <?php echo e(number_format($total-$price_coupon)); ?>₫
                                    </li>
                                </ul>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/childsplay/domains/childsplayclothing.vn/public_html/resources/views/cart/checkout.blade.php ENDPATH**/ ?>