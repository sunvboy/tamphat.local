  <?php if(!empty($productTwos) && count($productTwos) > 0): ?>
  ...
  <div class="space-y-2 mt-5">
      ...
      <div class="space-y-2">
          <?php $__currentLoopData = $productTwos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="space-y-2 itemProductTwo">
              ...
              <?php if(count($v->product_versions) > 0): ?>
              <?php $__currentLoopData = $v->product_versions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php
                $classVersion = '';
                $_stock = 0;
                ...
                ?>
              <div class="grid grid-cols-12 items-center gap-2 <?php echo e($classVersion); ?>">
                  <div class="">
                  </div>
                  ...
                  <div class="col-span-2"><input type="text" class="form-control int inputPrice" value="<?php echo e(!empty($priceDeals)?(!empty($priceDeals[$rowid]) ? $priceDeals[$rowid]['price'] : 0):0); ?>" rowid="<?php echo e($rowid); ?>"></div>
  ...
  <?php endif; ?><?php /**PATH D:\xampp\htdocs\evox.local\resources\views/product/backend/deals/common/product_two.blade.php ENDPATH**/ ?>