       ...
       <table class="table table-report -mt-2">
           ...
           <tbody id="table_data" role="alert" aria-live="polite" aria-relevant="all">
               ...
               <tr class="odd " id="post-<?php echo $v->id; ?>">
                   ...
                   <td>
                       <a class="text-primary font-bold" href="<?php echo e(route('payment_vouchers.edit',['id'=>$v->id])); ?>">
                           <?php echo e($v->code); ?>

                       </a>
                   </td>
                   <td>
                       <span class="text-primary"><?php echo e(!empty($v->payment_groups) ? $v->payment_groups->title:''); ?></span>
                   </td>
                   <td>
