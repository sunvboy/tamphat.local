...
<div id="section-rating-comment" class="flex flex-col bg-white rounded-lg mt-10">
    <div class="flex items-center space-x-2 mb-6">
        ...
        <h3 class="m-0 text-[19px] font-bold"><a href="javascript:void(0)"><?php echo e(trans('index.danhgiavanhanxet')); ?></a></h3>
    </div>
    ...
    <div class="grid grid-cols-12">
        <div class="col-span-12 md:col-span-5">
            <div class="flex items-center space-x-2">
                ...
                <div class="text-sm">
                    ...
                    <div>
                        <?php echo e($comment_view['totalComment']); ?> <?php echo e(trans('index.nhanxet')); ?>
        ...
        <div class="col-span-12 md:col-span-7 mt-5 md:mt-0">
            ...
            <div class="flex flex-col items-center justify-center">
                ...
                <span class="block text-[19px] font-bold"><?php echo e(trans('index.chuadanhgiavanhanxet')); ?></span>
                <span class="block text-[14px]">
                    <?php echo e(trans('index.nenmuahay')); ?>
            ...
            <div class="">
                <h2 class="text-lg font-medium mb-2"><?php echo e(trans('index.tatcahinhanh')); ?>(<?php echo !empty($list_images_cmt) ? count($list_images_cmt) : 0 ?>)</h2>
                ...
                <div class="grid grid-cols-6 space-x-2">
                    ...
                    <?php if($kimage <= 4): ?> <div class=" object-cover cursor-pointer border border-slate-100 mb-2 review_images_item">
        ...
        <div class="flex justify-center">
            ...
            @else
            <button type="button" onclick="handleLogin()" class="mt-4 flex items-center justify-center bg-red-600 h-12 rounded-md px-6 text-white font-semibold w-auto text-base">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
                </svg>
                {{trans('index.Comment')}}
...
<div class="col-span-12 mt-5">
    <div class="flex items-center">
        <div class="flex-shrink-0 mr-4 font-normal "><?php echo e(trans('index.locxemtheo')); ?></div>
        <div class="flex flex-wrap flex-grow space-x-2">
            <div class="filter_item mb-2 md:mb-0 h-8 font-medium text-sm leading-5 px-3 py-[6px] rounded-full text-[#38383d] bg-[#f5f5fa] cursor-pointer flex items-center">
                <div data-sort="id" class="filter_text flex items-center">
                    <span class="filter_check w-[18px] h-[18px] mr-[5px] hidden"><img src="<?php echo e(url('images/check.png')); ?>"></span>
                    <span><?php echo e(trans('index.Latest')); ?></span>
                </div>
            </div>
            <div class="filter_item mb-2 md:mb-0 h-8 font-medium text-sm leading-5 px-3 py-[6px] rounded-full text-[#38383d] bg-[#f5f5fa] cursor-pointer flex items-center">
                <div data-sort="gallery" class="filter_text flex items-center">
                    <span class="filter_check w-[18px] h-[18px] mr-[5px] hidden"><img src="<?php echo e(url('images/check.png')); ?>"></span>
                    <span><?php echo e(trans('index.cohinhanh')); ?></span>
                </div>
            </div>
            <div class="filter_item mb-2 md:mb-0 h-8 font-medium text-sm leading-5 px-3 py-[6px] rounded-full text-[#38383d] bg-[#f5f5fa] cursor-pointer flex items-center">
                <span class="filter_check w-[18px] h-[18px] mr-[5px] hidden"><img src="<?php echo e(url('images/check.png')); ?>"></span>
                <span data-sort="payment" class="filter_text"><?php echo e(trans('index.VerifiedBuyer')); ?></span>
            </div>
            <?php for ($i = 1; $i <= 5; $i++) { ?>
                <div class="filter_item mb-2 md:mb-0 h-8 font-medium text-sm leading-5 px-3 py-[6px] rounded-full text-[#38383d] bg-[#f5f5fa] cursor-pointer flex items-center">
                    <div data-sort="<?php echo e($i); ?>" class="filter_text flex items-center">
                        <span class="filter_check w-[18px] h-[18px] mr-[5px] hidden"><img src="<?php echo e(asset('images/check.png')); ?>"></span>
        ...
        <div class="relative py-8 px-5  bg-white shadow-md rounded border border-gray-400">
            ...
            <div class="modal-body relative pt-[15px] border-t border-[#e5e5e5]">
                <form id="form-comment">
                    <div class="write-review__heading text-lg leading-6 font-medium text-center mb-3"><?php echo e(trans('index.vuilongdanhgia')); ?></div>
                    ...
                    <div class="write-review__info flex-1 flex items-end justify-between mt-3">
                        <input value="" type="text" name="fullname" placeholder="<?php echo e(trans('index.Fullname')); ?>" class="w-[49%] h-9 leading-9 cursor-pointer rounded flex justify-center items-center outline-none focus:outline-none hover:outline-none border border-[#eeeeee] px-4 py-[6px] text-sm" required>
                        <input value="" type="text" name="phone" placeholder="<?php echo e(trans('index.Phone')); ?>" class="w-[49%] h-9 leading-9 cursor-pointer rounded flex justify-center items-center outline-none focus:outline-none hover:outline-none border border-[#eeeeee] px-4 py-[6px] text-sm">
                    </div>
                    <textarea rows="8" placeholder="<?php echo e(trans('index.sharettsp')); ?>" class="border border-[#eeeeee] p-4 rounded resize-none w-full outline-none focus:outline-none hover:outline-none my-4" name="message" required></textarea>
                    ...
                    <div class="flex-1 flex items-end justify-between m-0 ">
                        ...
                        <button type="button" class="write-review__button write-review__button--image w-1/2 h-9 leading-9 cursor-pointer rounded flex items-center justify-center text-blue-500 border-blue-500 border" style="background: #fff">
                            ...
                            <span class="ml-1"><?php echo e(trans('index.themanh')); ?></span>
                        </button>
                        <button type="submit" class="write-review__button write-review__button--submit w-1/2 bg-red-600 ml-4 h-9 leading-9 cursor-pointer rounded flex items-center justify-center text-white border-red-600 border"><span><?php echo e(trans('index.guidanhgia')); ?></span>
                        </button>
                    </div>
                </form>
            </div>
...
<link href="<?php echo e(asset('product/rating/bootstrap-rating.css')); ?>" rel="stylesheet">
<style>
...
<?php $__env->stopPush(); ?><?php /**PATH D:\xampp\htdocs\chuan.local\resources\views/product/frontend/product/comment/index.blade.php ENDPATH**/ ?>