...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="<?php echo e(route('rooms.store')); ?>" method="post" enctype="multipart/form-data">
        ...
        <div class=" col-span-12 lg:col-span-4">
            <div class=" box p-5 pt-3">
                <div>
                    ...
                    <?php echo Form::select('room_category_id', $htmlCatalogue, old('room_category_id'), ['class' => 'tom-select tom-select-custom w-full', 'data-placeholder' => "Select your favorite actors"]); ?>
                </div>
                <div class="mt-3">
                ...
                <div class="mt-3">
                    ...
                    <?php echo Form::text('code', !empty(old('code')) ? old('code') : $code, ['class' => 'form-control w-full']); ?>
                </div>
                <div class="mt-3">
                    <label class="form-label text-base font-semibold">Giá room</label>
                    <?php echo Form::text('price', '', ['class' => 'form-control w-full']); ?>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\chuan.local\resources\views/room/backend/room/create.blade.php ENDPATH**/ ?>