        ...
        <div class="flex flex-wrap justify-center">
            <div class="w-full md:w-1/2">
                <form action="" class="form-subscribe">
                    ...
                    <input type="text" placeholder="<?php echo e(trans('index.Fullname')); ?>*" name="fullname" class="w-full px-2 outline-none focus:outline-none hover:outline-none h-[45px] rounded-[5px] border border-gray-100 text-f15 mb-[20px]" />
                    ...
                    <input type="text" placeholder="<?php echo e(trans('index.Phone')); ?>*" name="phone" class="w-full px-2 outline-none focus:outline-none hover:outline-none h-[45px] rounded-[5px] border border-gray-100 text-f15 mb-[20px]" />
                    <input type="text" placeholder="<?php echo e(trans('index.Company')); ?>*" name="company" class="w-full px-2 outline-none focus:outline-none hover:outline-none h-[45px] rounded-[5px] border border-gray-100 text-f15 mb-[20px]" />
                    <textarea name="message" id="" cols="30" rows="10" placeholder="<?php echo e(trans('index.textWhy')); ?>" class="w-full px-2 py-2 outline-none focus:outline-none hover:outline-none h-[100px] rounded-[5px] border border-gray-100 text-f15"></textarea>
                    <div class="text-center">
                        <button type="submit" class="btn-submit button-link inline-block py-[10px] px-[25px] border rounded-[30px] text-white mt-[10px] md:mt-[20px] hover:bg-white hover:text-color_primary transition-all bg-color_primary border-color_primary">
                            <span><?php echo e(trans('index.sendRequiment')); ?></span>
                        </button>
                    </div>
                </form>
            </div>
