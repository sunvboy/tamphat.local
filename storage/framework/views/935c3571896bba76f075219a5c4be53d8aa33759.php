...
<div class="content">
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class=" col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2 justify-between">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('tours_create')): ?>
            <a href="<?php echo e(route('tours.create')); ?>" class="btn btn-primary shadow-md mr-2">Thêm mới</a>
            <?php endif; ?>
        </div>
        <!-- BEGIN: Data List -->
        <div class=" col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('tours_destroy')): ?>
                        <th style="width:40px;">
                ...
                <tbody id="table_data" role="alert" aria-live="polite" aria-relevant="all">
                    ...
                    <tr class="odd " id="post-<?php echo $v->id; ?>">
                        ...
                        <td class="whitespace-nowrap">
                            ...
                            <a class="text-danger" href="<?php echo e(route('tours.index',['catalogueid' => $c->id])); ?>"><?php echo !empty($kc == 0) ? '' : ',' ?><?php echo e($c->title); ?></a><br>
                        ...
                        <td class="table-report__action w-56 ">
                            <div class="flex justify-center items-center">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('tours_edit')): ?>
                                <a class="flex items-center mr-3" href="<?php echo e(route('tours.edit',['id'=>$v->id])); ?>">
                                    <i data-lucide="check-square" class="w-4 h-4 mr-1"></i>
                                    Edit
                                </a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('tours_destroy')): ?>
                                <a class="flex items-center text-danger ajax-delete" href="javascript:;" data-id="<?php echo $v->id ?>" data-module="<?php echo $module ?>" data-child="0" data-title="Lưu ý: Khi bạn xóa tour, tour sẽ bị xóa vĩnh viễn. Hãy chắc chắn rằng bạn muốn thực hiện hành động này!">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\chuan.local\resources\views/tour/backend/tour/index.blade.php ENDPATH**/ ?>