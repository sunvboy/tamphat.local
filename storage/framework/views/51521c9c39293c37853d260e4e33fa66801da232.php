...
<div id="offcanvas-cart" class="fixed w-[340px] top-0 bottom-0 bg-white overflow-hidden z-[9999] translate-x-full invisible right-0">
    <div class="p-4">
        <div class="flex flex-wrap justify-between items-center pb-6 mb-6 border-b border-solid border-gray-600">
            <h4 class="font-normal text-sm uppercase font-semibold"><?php echo e(trans('index.Cart')); ?></h4>
        ...
        <div id="cart-show-header" class="flex justify-between flex-col" <?php if (empty($cart['cart'])) { ?> style="display: none;height: calc(100vh - 110px);" <?php } else { ?>style="height: calc(100vh - 110px);" <?php } ?>>
            ...
            <div class="h-[234px] flex justify-end flex-col">
                ...
                <div class="text-center">
                    <a class="py-3 px-10 block bg-black border border-solid border-gray-600 uppercase font-semibold text-base hover:bg-red-600 hover:border-red-600 text-white transition-all leading-none" href="<?php echo e(route('cart.index')); ?>"><?php echo e(trans('index.Cart')); ?></a>

                    <a class="py-3 px-10 block bg-white border border-solid border-gray-600 uppercase font-semibold text-base hover:bg-red-600 hover:border-red-600  hover:text-white transition-all leading-none  mt-3" href="<?php echo e(route('cart.checkout')); ?>"><?php echo e(trans('index.Pay')); ?></a>
                </div>
            </div>
        </div>
        <div id="cart-none-header" <?php if (!empty($cart['cart'])) { ?> style="display: none" <?php } ?>>
            <div class="flex flex-col items-center justify-center space-y-4 text-center">
                <span class="block text-sm text-gray-400"><?php echo e(trans('index.ThereAreNo')); ?></span>
            </div>
        </div>
    </div>
</div>
...
<!-- end --><?php /**PATH /home/childsplay/domains/childsplayclothing.vn/public_html/resources/views/homepage/common/cart.blade.php ENDPATH**/ ?>