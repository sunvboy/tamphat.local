                    ...
                    <tr class="odd " id="post-<?php echo $v->id; ?>" class="cursor-pointer">
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                ...
                                <a class="flex items-center mr-3 js_edit_receipt_groups" href="javascript:void(0)" data-id="<?php echo e($v->id); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\evox.local\resources\views/cashbook/receipt/group/index.blade.php ENDPATH**/ ?>