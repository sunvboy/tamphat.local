...
<div class="content">
    ...
    <div class=" mt-3 flex flex-col md:flex-row gap-2 justify-between md:items-center">
        ...
        <div>
            ...
            <a href="<?php echo e(route('suppliers_categories.index')); ?>" class="btn btn-danger shadow-md">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/childsplay/domains/childsplayclothing.vn/public_html/resources/views/suppliers/suppliers/index.blade.php ENDPATH**/ ?>