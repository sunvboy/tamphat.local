...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="<?php echo e(route('rooms.update',['id' => $detail->id])); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class=" box p-5">
                ...
                <div class="tab-content">
                    <div id="example-tab-homepage" class="tab-pane leading-relaxed active" role="tabpanel" aria-labelledby="example-homepage-tab">
                        <div>
                            <label class="form-label text-base font-semibold">Tiêu đề room</label>
        ...
        <div class=" col-span-12 lg:col-span-4">
            ...
            <div class="box p-5 pt-3 mt-3">
                <div>
                    ...
                    <?php echo Form::select('room_category_id', $htmlCatalogue, !empty(old('room_category_id')) ? old('room_category_id') : (!empty($detail->room_category_id) ? $detail->room_category_id : ''), ['class' => 'tom-select-custom tom-select w-full', 'data-placeholder' => "Select your favorite actors"]); ?>
                </div>
                <div class="mt-3">
                ...
                <?php
                $code = CodeRender('rooms');
                ?>
                <div class="mt-3">
                    <label class="form-label text-base font-semibold">Mã room</label>
                    <?php echo Form::text('code', $detail->code, ['class' => 'form-control w-full']); ?>
                </div>
                <div class="mt-3">
                    <label class="form-label text-base font-semibold">Giá room</label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\chuan.local\resources\views/room/backend/room/edit.blade.php ENDPATH**/ ?>