...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="<?php echo e(route('receipt_vouchers.store')); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
        <div class=" col-span-12 lg:col-span-8">
            ...
            <div class="box p-5 grid grid-cols-2 gap-2">
                ...
                <div class="col-span-2 md:col-span-1">
                    <label class="form-label text-base font-semibold">Nhóm<span style="color:red">*</span></label>
                ...
                <div class="col-span-2 md:col-span-1">
                    <label class="form-label text-base font-semibold">Đối tượng</label>
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <?php echo Form::select('group_id', $categories, !empty(old('group_id')) ? old('group_id') : (!empty($detail->group_id) ? $detail->group_id : ''), ['class' => 'tom-select tom-select-custom w-full', 'data-placeholder' => "Tìm kiếm loại phiếu thu"]); ?>
                </div>
                <div class="col-span-2 md:col-span-1">
...
<script>
    $(document).on('change', 'select[name="module"]', function(e) {
        $.ajax({
            url: "<?php echo route('receipt_vouchers.getModule') ?>",
            type: 'POST',
            data: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\evox.local\resources\views/cashbook/receipt/receipt/create.blade.php ENDPATH**/ ?>